...
######################## VCN Parameters ########################
variable "VCNname" { default = "TfVcn01" }
...
variable "computeName" { default = "TfOrdsJettySrv001" }
######################## OTHER Parameters ########################
variable "ATP_tde_wallet_zip_file" { default = "tde_wallet_TfAtpPub02.zip" } #replace file name
variable "oracle_instant_client_version" { default = "19.9" }
variable "oracle_instant_client_version_short" { default = "19.9" }

variable "identity_tag" { default = "TfAOrdsAtpPubEp" }
...
######################## ADB Parameters ########################
variable "ATP_pubdb_name" { default = "TfAtpPub02" }
